...
export default class HorairesSemaine extends React.Component {
    ...
    UNSAFE_componentWillMount = async () =>{
        ...
        await firebase.database().ref(`projects/`+firebase.auth().currentUser.uid+`/`+_id+`/calendrierBusiness/HorairesSemaine/`).on('value', snapshot => {
    ...
    handleConfirm_1 = (date) => {
        ...
        firebase.database().ref(`projects/`+firebase.auth().currentUser.uid+`/`+_id+`/calendrierBusiness/HorairesSemaine/Matin/`).update({
    ...
    handleConfirm_2 = (date) => {
        ...
        firebase.database().ref(`projects/`+firebase.auth().currentUser.uid+`/`+_id+`/calendrierBusiness/HorairesSemaine/ApresMidi/`).update({
            debut : currentTime.getHours()+':'+currentTime.getMinutes()
        });
        this.setState({show_2 : false});
    };
    ...
    handleConfirm_3 = (date) => {
        ...
        firebase.database().ref(`projects/`+firebase.auth().currentUser.uid+`/`+_id+`/calendrierBusiness/HorairesSemaine/Soir/`).update({
            debut : currentTime.getHours()+':'+currentTime.getMinutes()
        });
        this.setState({show_3 : false});
    };
